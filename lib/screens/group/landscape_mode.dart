    ...
    return Row(
      children: [
        Consumer<GroupsProvider>(
          builder: (context, groupSettings, child) => Expanded(
            child: ListView(
                            ...
                            (folder) => InkWell(
                              onTap: () {
                                groupSettings.setSelectedFolder(
                                    folder: folder, groupName: group.name);
                              },
                              child: Padding(
                                ...
                                child: ListTile(
                                  leading: Icon(Icons.folder_rounded,
                                      color: folder.hashCode ==
                                              groupSettings
                                                  .getSelectedFolder.hashCode
                                          ? AppColors.selectedgroupFolderColor
                                          : AppColors
                                          ...
                                          ? Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  RequestRow(
                                                    title: "Headers",
                                                    data: folder.requests[index]
                                                            .key.header.isEmpty
                                                        ? "Empty"
                                                        : folder.requests[index]
                                                            .key.header
                                                            .print(),
                                                  ),
                                                  RequestRow(
