                          ...
                          children: [
                            Consumer<HomeProvider>(
                              builder: (context, value, child) =>
                                ...
                                onChanged: (HttpTypes? type) => value
                                    .setHttpType(type: type ?? HttpTypes.https),
                              ),
                            ),
                            10.wh(),
                            Expanded(
                              child: CustomTextField(
                                  ...
                                  hintText:
                                      "e.g. 127.0.0.1:8000 , localhost:8000,..."),
                            ),
                          ],
                        ),
                        20.wh(),
